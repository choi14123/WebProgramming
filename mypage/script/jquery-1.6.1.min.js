...
(function (a, b) {
        ...
        f = function () {
            ...
            e.extend({
                ...
                parseXML: function (b, c, d) {
                    ...
                    d = c.documentElement,
                    (!d || !d.nodeName || d.nodeName === "parsererror") && e.error(
                        "Invalid XML: " + b
                    );
                    return c
                },
    ...
    f.support = function () {
        ...
        a.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>" +
    ...
    f.event = {
        ...
        remove: function (a, c, d, e) {
            if (a.nodeType !== 3 && a.nodeType !== 8) {
                ...
                while (h = c[k++]) {
                    ...
                    l = h.indexOf(".") < 0,
                    m = [],
                    l || (m = h.split("."), h = m.shift(), n = new RegExp(
            ...
            if (!!e && !f.event.customEvent[h] || !!f.event.global[h]) {
                ...
                if (!e) {
                    f.each(f.cache, function () {
                        var a = f.expando,
                            b = this[a];
                        b && b.events && b.events[h] && f
                            .event
                            .trigger(c, d, b.handle.elem)
                    });
                    return
                }
        ...
        fix: function (a) {
            ...
            if (a.pageX == null && a.clientX != null) {
                ...
                a.pageY = a.clientY + (i && i.scrollTop || j && j.scrollTop || 0) - (
        ...
        special: {
            ...
            live: {
                add: function (a) {
                    f
                        .event
                        .add(this, O(a.origType, a.selector), f.extend({}, a, {
                            handler: N,
                            guid: a.handler.guid
                        }))
                },
                remove: function (a) {
                    f
                        .event
                        .remove(this, O(a.origType, a.selector), a)
                }
            },
            beforeunload: {
                ...
                f
                    ...
                    .add(this, "click.specialSubmit", function (a) {
                        ...
                        (c === "submit" || c === "image") && f(b)
                            .closest("form")
                            .length && L("submit", this, arguments)
                    }),
                f
                    .event
                    .add(this, "keypress.specialSubmit", function (a) {
                        ...
                        (c === "text" || c === "password") && f(b)
                            .closest("form")
                            .length && a.keyCode === 13 && L("submit", this, arguments)
                    });
            else 
                return !1
        },
    ...
    if (!f.support.changeBubbles) {
        ...
        f.event.special.change = {
            filters: {
                ...
                click: function (a) {
                    var b = a.target,
                        c = f.nodeName(b, "input")
                            ? b.type
                            : "";
                    (c === "radio" || c === "checkbox" || f.nodeName(b, "select")) && K.call(
                        this,
                        a
                    )
                },
                keydown: function (a) {
                    var b = a.target,
                        c = f.nodeName(b, "input")
                            ...
                            : "";
                    (
                        a.keyCode === 13 && !f.nodeName(b, "textarea") || a.keyCode === 32 && (c === "checkbox" || c === "radio") || c === "select-multiple"
                    ) && K.call(this, a)
                },
        ...
        var k = function (b, d, f, g) {
            ...
            if (e.call(n) === "[object Array]") 
                if (!u) 
                    ...
                    for (t = 0; n[t] != null; t++) 
                        n[t] && (n[t] === !0 || n[t].nodeType === 1 && k.contains(d, n[t])) && f.push(
                            j[t]
                        );
        else 
                for (t = 0; n[t] != null; t++) 
    ...
    f
        ...
        .extend({
            ...
            closest: function (a, b) {
                ...
                var l = U.test(a) || typeof a != "string"
                    ? f(a, b || this.context)
                    : 0;
    ...
    f.buildFragment = function (a, b, d) {
        var e,
            ...
            i = b && b[0]
                ...
                : c;
        a.length === 1 && typeof a[0] == "string" && a[0].length < 512 && i === c && a[0].charAt(
            0
                    ...
                    if (!bb.test(k)) 
                        ...
                        if (!f.support.tbody) {
                            ...
                            for (i = q.length - 1; i >= 0; --i) 
                                f.nodeName(q[i], "tbody") && !q[i].childNodes.length && q[i]
                                    .parentNode
                                    .removeChild(q[i])
                            }
                        !f.support.leadingWhitespace && Z.test(k) && o.insertBefore(
    ...
    c.defaultView && c.defaultView.getComputedStyle && (bA = function (a, c) {
        ...
        if (g = e.getComputedStyle(a, null)) 
            ...
            d === "" && !f.contains(a.ownerDocument.documentElement, a) && (
                d = f.style(a, c)
            );
        return d
    }),
                ...
                f.ajax({
                    ...
                    complete: function (a, b, c) {
                        ...
                        a.isResolved() && (a.done(function (a) {
                            ...
                            g
                                ? f("<div>").append(c.replace(bO, "")).find(g)
                                : c
                        )),
                        d && i.each(d, [c, b, a])
                    }
    ...
    f.extend({
        ...
        ajax: function (a, c) {
            ...
            d.crossDomain == null && (
                ...
                d.crossDomain = !(!r || r[1] == bX[1] && r[2] == bX[2] && (r[3] || (
                    r[1] === "http:"
                        ? 80
                        : 443
                )) == (bX[3] || (
            ...
            hide: function (a, b, c) {
                ...
                for (var d = 0, e = this.length; d < e; d++) 
                    if (this[d].style) {
                        ...
                        g !== "none" && !f._data(this[d], "olddisplay") && f._data(
                            this[d],
                            "olddisplay",
                            g
                        )
    ...
    f.fx.prototype = {
        ...
        show: function () {
            this
                .options
                .orig[this.prop] = f.style(this.elem, this.prop),
            this.options.show = !0,
            this.custom(
        ...
        : f.fn.offset = function (a) {
            ...
            while ((b = b.parentNode) && b !== i && b !== h) {
                ...
                b === d && (
                    l += b.offsetTop,
                    m += b.offsetLeft,
                    f.offset.doesNotAddBorder && (!f.offset.doesAddBorderForTableAndCells || !cw.test(b.nodeName)) && (l += parseFloat(c.borderTopWidth) || 0, m += parseFloat(c.borderLeftWidth) || 0),
                    e = d,
                    d = b.offsetParent
                ),
                f.offset.subtractsBorderForOverflowNotVisible && c.overflow !== "visible" && (
    ...
    f.offset = {
        initialize: function () {
            var a = c.body,
                ...
                j = "<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padd" +
    ...
    f.each([
        ...
        f.fn[d] = function (a) {
            ...
            if (f.isWindow(e)) {
                ...
                return e.document.compatMode === "CSS1Compat" && g || e
                    .document
                    .body["client" + c] || g
            }
            if (e.nodeType === 9) 
